...
photologo = 'https://i.ibb.co/ccV44ZRS/STRANGER-BOY.jpg' #https://envs.sh/GV0.jpg
photoyt = 'https://i.ibb.co/7xm7cXyg/STRANGER-BOY.jpg' #https://envs.sh/GVi.jpg
photocp = 'https://i.ibb.co/ccV44ZRS/STRANGER-BOY.jpg'
photozip = 'https://i.ibb.co/ZRvCxd5g/STRANGER-BOY.jpg'


# Inline keyboard for start command
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/+kHZnTWoKmlZiYTY1")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+kHZnTWoKmlZiYTY1")        ],
    ]
)
    ...
    try:
        if m.chat.type == "channel":
            ...
            if not is_authorized:
                await m.reply_photo(
                    ...
                    reply_markup=InlineKeyboardMarkup([
                        [InlineKeyboardButton("💫 Get Access", url="https://t.me/+kHZnTWoKmlZiYTY1")]
                    ])
                )
                return
            ...
            await m.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📚 Help", url="https://t.me/+kHZnTWoKmlZiYTY1")]])
            )
...
async def unauthorized_handler(client, message: Message):
    await message.reply(
        ...
        reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton("💫 Get Premium Access", url="https://t.me/+kHZnTWoKmlZiYTY1")
        ]])
    )
