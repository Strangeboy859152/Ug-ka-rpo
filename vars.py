...
CREDIT = os.environ.get("CREDIT", "〱ŞŤŘÃŇĞ€Ř 》▕")
...
PREMIUM_CHANNEL = "https://t.me/+kHZnTWoKmlZiYTY1"
# Thumbnail Configuration
THUMBNAILS = list(map(str, os.environ.get("THUMBNAILS", "https://i.ibb.co/ZRvCxd5g/STRANGER-BOY.jpg").split()))
